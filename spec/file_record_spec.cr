require "spec"
require "../src/verisum/file_record"

describe Verisum::FileRecord do
  it "can be created with a checksum and file path" do
    record = Verisum::FileRecord.new("checksumchecksum", Path["/path/to/file"])
  ...
  it "can guess the algorithm sha256 based on the checksum length" do
    record = Verisum::FileRecord.new("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", Path["/path/to/file"])
    record.guess_algorithm.should eq Verisum::Algorithm::SHA256
  end

  it "can guess the algorithm sha512 based on the checksum length" do
    record = Verisum::FileRecord.new("cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e", Path["/path/to/file"])
    record.guess_algorithm.should eq Verisum::Algorithm::SHA512
  end

  it "raises an error if the checksum length is unknown" do
    expect_raises Verisum::UnknownAlgorithmError do
      Verisum::FileRecord.new("unknownchecksum", Path["/path/to/file"]).guess_algorithm
    end
  end
end
